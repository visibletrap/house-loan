(ns house-loan.core
  (:require [house-loan.date :as d]
            ...
            [house-loan.extract :as e]))

(defn- date-string-list [from nmonth]
  (take nmonth (d/range-last-date-of-month-string from)))

(defn- dates-to-csvs [dates]
  (map s/csv dates))
